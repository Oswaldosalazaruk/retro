defmodule RetroWeb.GameLiveTest do
  use RetroWeb.ConnCase

  import Phoenix.LiveViewTest
  import Retro.GamesFixtures

  @create_attrs %{cont: 42, name: "some name"}
  @update_attrs %{cont: 43, name: "some updated name"}
  @invalid_attrs %{cont: nil, name: nil}
